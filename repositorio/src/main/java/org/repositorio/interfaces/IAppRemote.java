...
public interface IAppRemote extends Remote {
	...
	MesaDTO abrirMesa(AbrirMesaDTO dto) throws RuntimeException, RemoteException;
	...
	MozoDTO getDatosMozo(int idMozo) throws RemoteException;

	List<ComandaDTO> listarComandasMozo(int idMozo) throws RemoteException;
